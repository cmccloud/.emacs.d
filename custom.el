...
(custom-set-variables
 ...
 '(Man-width 75 t nil "Customized with use-package man")
 ...
 '(doom-themes-enable-bold t t nil "Customized with use-package doom-themes")
 '(doom-themes-enable-italic nil t nil "Customized with use-package doom-themes")
 ...
 '(helm-M-x-fuzzy-match t nil nil "Customized with use-package helm-command")
 ...
 '(helm-grep-ag-command
   "ag --line-numbers -S -W 256 --hidden --nocolor --nogroup %s %s %s" nil nil "Customized with use-package helm-grep")
 ...
 '(initial-frame-alist '((top . 30) (left . 50) (width . 90) (height . 50)))
 ...
 '(magit-repository-directories
   '(("/Users/Macnube/Repos" . 1)
     ...
     ("/Users/Macnube/.emacs.d/site-lisp" . 1)) nil nil "Customized with use-package magit")
 ...
 '(package-selected-packages
   '(racket-mode macrostep darktooth-theme spacemacs-theme cider clojure-mode delight helm-dash pcre2el tide js2-mode intero ace-window wgrep which-key company-box magit zenburn-theme doom-themes helm lispy magithub smartparens yasnippet geiser osx-trash wgrep-ag wgrep-helm smart-jump helm-ls-git visual-regexp-steroids visual-regexp ag rg company company-quickhelp dumb-jump git-commit use-package persp-mode helm-descbinds helm-describe-modes helm-themes bind-key hydra page-break-lines all-the-icons visual-fill-column company-web rainbow-mode paradox expand-region web-mode f request-deferred deferred request shm haskell-mode diff-hl markdown-mode vmd-mode eyebrowse golden-ratio flycheck js-doc projectile smooth-scrolling elisp-slime-nav window-numbering shackle exec-path-from-shell avy))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :slant normal :weight normal :height 110 :width normal :foundry "nil" :family "Input"))))
