...
(custom-set-variables
 ...
 '(ag-reuse-window t t)
 '(all-the-icons-scale-factor 1 t)
 ...
 '(avy-background t)
 '(avy-style 'at)
 '(aw-keys '(49 50 51 52 53 54 55 56 57 48) t)
 ...
 '(company-box-max-candidates 500 t)
 ...
 '(completion-ignored-extensions
   '(".DS_Store" ".DS_Store" ".DS_Store" ".DS_Store" ".DS_Store" ".DS_Store" ".DS_Store" ".DS_Store" ".DS_Store" ".DS_Store" ".DS_Store" ".hi" ".o" "~" ".bin" ".lbin" ".so" ".a" ".ln" ".blg" ".bbl" ".elc" ".lof" ".glo" ".idx" ".lot" ".svn/" ".hg/" ".git/" ".bzr/" "CVS/" "_darcs/" "_MTN/" ".fmt" ".tfm" ".class" ".fas" ".lib" ".mem" ".x86f" ".sparcf" ".dfsl" ".pfsl" ".d64fsl" ".p64fsl" ".lx64fsl" ".lx32fsl" ".dx64fsl" ".dx32fsl" ".fx64fsl" ".fx32fsl" ".sx64fsl" ".sx32fsl" ".wx64fsl" ".wx32fsl" ".fasl" ".ufsl" ".fsl" ".dxl" ".lo" ".la" ".gmo" ".mo" ".toc" ".aux" ".cp" ".fn" ".ky" ".pg" ".tp" ".vr" ".cps" ".fns" ".kys" ".pgs" ".tps" ".vrs" ".pyc" ".pyo"))
 ...
 '(dimmer-exclusion-predicates '(helm--alive-p window-minibuffer-p) t)
 '(dimmer-exclusion-regexp-list
   '("^\\*[h|H]elm.*\\*" "^\\*Minibuf-[0-9]+\\*" "^.\\*which-key\\*$") t)
 ...
 '(echo-keystrokes 0.2)
 '(ediff-keep-variants t t)
 '(ediff-split-window-function 'split-window-horizontally t)
 '(ediff-window-setup-function 'ediff-setup-windows-plain t)
 '(emmet-indentation 2)
 '(enable-local-variables :safe)
 '(enable-recursive-minibuffers t)
 '(eshell-directory-name "/Users/Macnube/.emacs.d/cache/eshell/" t)
 '(exec-path
 ...
 '(flycheck-error-list-minimum-level 'error t)
 ...
 '(golden-ratio-exclude-buffer-names '("*tide-documentation*") t)
 ...
 '(helm-imenu-delimiter ": " t)
 '(helm-imenu-fuzzy-match nil t)
 '(helm-locate-command "mdfind -name %s %s")
 '(helm-locate-fuzzy-match nil)
 '(helm-ls-git-status-command 'magit-status-internal t)
 ...
 '(helm-semantic-display-style nil t)
 ...
 '(js-flat-functions t t)
 '(js-indent-align-list-continuation t t)
 '(js-indent-level 2)
 ...
 '(magithub-clone-default-directory "/Users/Macnube/Repos/" t)
 '(magithub-dashboard-show-read-notifications nil t)
 '(magithub-datetime-format "%A %B %e%l:%M%p %Y" t)
 '(magithub-dir "~/.emacs.d/cache/magithub" t)
 '(magithub-preferred-remote-method 'clone_url t)
 ...
 '(package-selected-packages
   '(spacemacs-theme cider clojure-mode delight helm-dash pcre2el tide js2-mode intero ace-window wgrep which-key company-box magit zenburn-theme doom-themes helm lispy magithub slime smartparens yasnippet geiser osx-trash darktooth-theme wgrep-ag wgrep-helm smart-jump helm-ls-git slime-company visual-regexp-steroids visual-regexp ag rg company company-quickhelp dumb-jump git-commit use-package persp-mode helm-descbinds helm-describe-modes helm-themes bind-key hydra page-break-lines all-the-icons visual-fill-column company-web rainbow-mode paradox expand-region web-mode f request-deferred deferred request shm haskell-mode diff-hl markdown-mode vmd-mode eyebrowse golden-ratio flycheck js-doc racket-mode projectile smooth-scrolling elisp-slime-nav window-numbering shackle exec-path-from-shell avy))
 '(package-user-dir "~/.emacs.d/elpa")
 '(paradox-column-width-package 30 t)
 '(paradox-execute-asynchronously t t)
 '(paradox-github-token t t)
 '(paradox-lines-per-entry 1 t)
 '(paradox-use-homepage-buttons nil t)
 '(pdf-view-display-size 'fit-height)
 '(pdf-view-midnight-colors '("#DCDCCC" . "#383838"))
 '(pdf-view-use-imagemagick t)
 '(pdf-view-use-scaling t)
 '(persp-add-buffer-on-after-change-major-mode t t)
 '(persp-auto-resume-time 0 t)
 '(persp-auto-save-opt 1 t)
 '(persp-autokill-buffer-on-remove nil t)
 '(persp-init-frame-behaviour 'persp-ignore-wconf t)
 ...
 '(semantic-elisp-store-documentation-in-tag nil t)
 '(semantic-idle-scheduler-idle-time 10 t)
 '(semantic-stickyfunc-indent-string " " t)
 ...
 '(shackle-rules
   '(("*Process List*" :custom shackle-set-no-other-window :select t :align below :size 0.3)
     ...
     ("^\\*ag.search.text:.*\\*$" :regexp t :select t :other t :inhibit-window-quit t)
     ("^\\*xwidget.webkit:.*\\*" :regexp t :select t :other t :inhibit-window-quit t)))
 '(shackle-select-reused-windows t)
 '(shell-file-name "/bin/zsh")
 '(show-paren-delay 0.05)
 '(show-paren-mode t)
 '(slime-kill-without-query-p t)
 '(smart-jump-bind-keys nil t)
 '(smartrep-mode-line-active-bg (solarized-color-blend "#859900" "#073642" 0.2))
 '(sml/active-background-color "#34495e")
 '(sml/active-foreground-color "#ecf0f1")
 '(sml/inactive-background-color "#dfe4ea")
 '(sml/inactive-foreground-color "#34495e")
 '(sp-echo-match-when-invisible nil t)
 ...
 '(standard-indent 2)
 '(tab-width 8)
 '(term-buffer-maximum-size 1024 t)
 '(term-default-bg-color "#002b36")
 '(term-default-fg-color "#839496")
 '(term-suppress-hard-newline t t)
 '(tool-bar-mode nil)
 ...
 '(visible-bell nil)
 '(visible-cursor nil)
 '(vr/default-replace-preview nil t)
 '(vr/engine 'pcre2el)
 '(weechat-color-list
 ...
 '(whitespace-style '(face lines-tail) t)
