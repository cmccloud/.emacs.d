...
(custom-set-variables
 ...
 '(package-selected-packages
   '(osx-trash lispy magithub lastpass darktooth-theme ivy wgrep-ag wgrep-helm smart-jump helm-ls-git helm-rg slime-company visual-regexp-steroids visual-regexp ag rg helpful doom-themes company helm-xref helm-unicode stripe-buffer eldoc-eval company-quickhelp dumb-jump git-commit use-package persp-mode helm helm-core helm-descbinds helm-describe-modes helm-themes bind-key hydra spacemacs-theme page-break-lines all-the-icons writeroom-mode visual-fill-column impatient-mode company-web rainbow-mode company-tern clojure-mode paradox pdf-tools expand-region web-mode f request-deferred deferred request shm intero haskell-mode diff-hl markdown-mode vmd-mode nodejs-repl eyebrowse golden-ratio flycheck skewer-mode js-doc racket-mode projectile smooth-scrolling elisp-slime-nav window-numbering shackle magit js2-mode exec-path-from-shell cider avy))
